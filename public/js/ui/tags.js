...
export const ACCENT_TAGS = ['夹子音', '御姐音', '正太音', '大叔音', '台湾腔', '东北话', '四川话', '河南话', '粤语'];
...
export function initTags(root, state, handlers) {
  ...
  TAG_GROUPS.forEach((g, i) => {
    ...
    b.addEventListener('click', () => {
      ...
      body.querySelectorAll('.tag-group').forEach(x => x.classList.remove('active'));
