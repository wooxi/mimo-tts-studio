...
export function applyConfig(cfg) {
  ...
  if (MODELS[state.model]?.supportsStream && cfg.stream != null)
  ...
  if (typeof cfg.directorRole === "string")
    state.director.role = cfg.directorRole;
  if (typeof cfg.directorScene === "string")
    state.director.scene = cfg.directorScene;
  if (typeof cfg.directorGuide === "string")
    state.director.guide = cfg.directorGuide;
  if (typeof cfg.text === "string") state.text = cfg.text;
  if (Array.isArray(cfg.styleTags)) {
    state.styleTags = new Set(
      cfg.styleTags.filter((t) => typeof t === "string"),
    );
  }
